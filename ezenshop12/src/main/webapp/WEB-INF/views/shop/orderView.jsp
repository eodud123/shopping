		...
		<div id="container_box">
 		...
 		<ul class="orderView">
 			 <c:forEach items="${orderView}" var="orderView">     
  			 <li>
  				 <div class="thumb">
    			 	<img src="${pageContext.request.contextPath}/${orderView.GOODS_THUMBIMG}" />
   				 </div>
   				 
   				 <div class="gdsInfo">
    				<p>
					     <span>상품명</span> : ${orderView.GOODS_NAME}<br /> </p>
					   <p>  <span>개당 가격</span> : <fmt:formatNumber pattern="###,###,###" value="${orderView.GOODS_PRICE}" /> 원<br /> </p>
					     
					    <p> <span>구입 수량</span> : ${orderView.CARTSTATUS} 개<br /> </p>
					     <p><span>최종 가격</span> : <fmt:formatNumber pattern="###,###,###" value="${orderView.GOODS_PRICE * orderView.CARTSTATUS}" /> 원 </p>
					     <p><span>최종 할인 가격</span> : <fmt:formatNumber pattern="###,###,###" value="${orderView.GOODS_DCPRICE * orderView.CARTSTATUS}" /> 원                    
   					</p>
  				 </div>
 			 </li>     
			 </c:forEach>
