	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".cancel_btn").on("click", function(){
				...
				location.href = "/controller/qna/QnaDetail?qna_no=${modify.qna_no}"
					   + "&page=${scri.page}"
			...
			$(".update_btn").on("click", function(){
				...
				formObj.attr("action", "/controller/qna/QnaModify");
	...
	<body>
		...
		<div id="container" role="main">
			...
			<section id="container">
				<form name="updateForm" role="form" method="post" action="/controller/qna/QnaModify" enctype="multipart/form-data">
