  ...
  border-bottom: 1px solid #ccc;
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".write_btn").on("click", function(){
				...
				formObj.attr("action", "/controller/qna/QnaWrite");
			});
			fn_addFile();
		})
		
		function moveList(){
			location.href = "/controller/qna/QnaList";
		}
	...
	<body>
		...
		<div id="root">
			...
			<c:if test="${msg == null }">
				<form name="writeForm" method="post" action="/controller/qna/QnaWrite" enctype="multipart/form-data">
					<div class="col-xs-10 col-sm-10">
            			<div class="col-10">
            				<div class="form-group">
								...
								<div class="form-group">
										<label for="title">제목</label><input type="text" id="title" name="qna_title" class="chk form-control" title="제목을 입력하세요." placeholder="제목을 입력하세요."/>
								</div>	
								<div class="form-group">
										<label for="content">내용</label><textarea id="content" name="qna_content" class="chk form-control" title="내용을 입력하세요." placeholder="내용을 입력하세요."></textarea>
								</div>
								<div class="form-group">
