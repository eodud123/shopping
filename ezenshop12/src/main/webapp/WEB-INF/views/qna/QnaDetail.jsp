	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$(".delete_btn").on("click", function(){
				...
				formObj.attr("action", "/controller/qna/QnaDelete");
			...
			$(".list_btn").on("click", function(){
				...
				location.href = "/controller/qna/QnaList?page=${scri.page}"
			...
			$(".commentModify").on("click", function(){
				location.href = "/controller/qna/commentModify?qna_no=${read.qna_no}"
								+ "&page=${scri.page}"
								+ "&perPageNum=${scri.perPageNum}"
			...
			$(".commentDelete").on("click", function(){
				location.href = "/controller/qna/commentDelete?qna_no=${read.qna_no}"
					+ "&page=${scri.page}"
					+ "&perPageNum=${scri.perPageNum}"
					+ "&searchType=${scri.searchType}"
					+ "&keyword=${scri.keyword}"
		...
		function fn_fileDown(fileNo){
			...
			formObj.attr("action", "/controller/qna/fileDown");
			formObj.submit();
		} 
		//원본 이미지 팝업
		...
		<div class="container">
			...
			<section id="container">
				...
				<div class="form-group">
					...
					<input type="text" id="title" name="title" class="form-control" value="${read.qna_title}" readonly="readonly" />
				</div>
				<div class="form-group">
					<label for="content" class="col-sm-2 control-label">내용</label>
					<textarea id="content" name="content" class="form-control" readonly="readonly"><c:out value="${read.qna_content}" /></textarea>
				</div>
				<div class="form-group">
				...
				<div class="form-group" style="border: 1px solid #dbdbdb;">
					<c:forEach var="file" items="${file}">
							...
							<img src="/controller/qna/fileDown?FILE_NO=${file.FILE_NO}" width=100 height=100 onclick="OnloadImg(this.src)"/>
					</c:forEach>
				</div>
				<hr>
				<div>
