...
<jsp:include page="../common/header.jsp"></jsp:include>
 	...
 	<div class="col-lg-0">	
		...
		<form role="form" method="post" autocomplete="off">
	 		...
	 		<div class="form-row">
	 		 	<label>1차 분류</label>
		 			<span class="category1">${goods.GOODS_CATEGORY}</span>
		...
		<div class="inputArea">
			<button type="button" id="goodsmodify_Btn" class="btn btn-warning">수정</button>
			<button type="button" id="goodsdelete_Btn" class="btn btn-danger">삭제</button>
			<script>
