	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".cancel_btn").on("click", function(){
				...
				location.href = "/controller/member/myReportView?report_no=${modify.report_no}";
			})
	...
	<body>
		...
		<div id="container" role="main">
			...
			<section id="container">
				<form name="updateForm" role="form" method="post" action="/controller/member/myReportModify" enctype="multipart/form-data">
