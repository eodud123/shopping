	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".cancel_btn").on("click", function(){
				...
				location.href = "/controller/member/myQnaView?qna_no=${modify.qna_no}";
			})
			...
			$(".update_btn").on("click", function(){
				...
				formObj.attr("action", "/controller/member/myQnaModify");
	...
	<body>
		...
		<div id="container" role="main">
			...
			<section id="container">
				<form name="updateForm" role="form" method="post" action="/controller/member/myQnaModify" enctype="multipart/form-data">
					<input type="hidden" name="qna_no" value="${modify.qna_no}" readonly="readonly"/>
            			...
            			<div class="col-10">
            					<div class="form-group">
									<label for="cate"></label>
										<select name="qnacate" id="cate" class="form-control">
											<option title="">--</option>
											<option value="상품문의">상품문의</option>
											<option value="배송문의">배송문의</option>
											<option value="교환/반품/환불문의">교환/반품/환불문의</option>
											<option value="기타문의">기타문의</option>
										</select>
									</div>
								<div class="form-group">	
									<label for="title">제목</label><input type="text" id="title" name="qna_title" value="${modify.qna_title}" class="chk form-control" title="제목을 입력하세요."/>
								</div>
								<div class="form-group">
									<label for="content">내용</label><textarea id="content" name="qna_content" class="chk form-control" title="내용을 입력하세요."><c:out value="${modify.qna_content}" /></textarea>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<fmt:formatDate value="${modify.qna_date}" pattern="yyyy-MM-dd"/>					
								</div>
							<table>
							<tr>
								<td id="fileIndex">
									...
									<div class="col-sm-10">
										...
										<button id="fileDel" onclick="fn_del('${file.FILE_NO}','FILE_NO_${var.index}');" type="button" class="btn btn-danger btn-sm" style="float: right;">삭제</button><br>
									</div>
									</c:forEach>
								</td>
							</tr>
