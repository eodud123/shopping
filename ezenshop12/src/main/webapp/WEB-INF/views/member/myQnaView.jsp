...
<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$(".delete_btn").on("click", function(){
				...
				formObj.attr("action", "/controller/member/myQnaRemove");
...
<div class="container">
			...
			<section id="container">
				<form name="readForm" role="form" method="post">
					<input type="hidden" id="qna_no" name="qna_no" value="${boardRead.qna_no}" />
					<input type="hidden" id="FILE_NO" name="FILE_NO" value=""> 
				</form>
				
				<div class="form-group">
					<label for="title" class="col-sm-2 control-label">제목</label>
					<input type="text" id="title" name="title" class="form-control" value="${boardRead.qna_title}" readonly="readonly" />
				</div>
				<div class="form-group">
					<label for="content" class="col-sm-2 control-label">내용</label>
					<textarea id="content" name="content" class="form-control" readonly="readonly"><c:out value="${boardRead.qna_content}" /></textarea>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<fmt:formatDate value="${boardRead.qna_date}" pattern="yyyy-MM-dd" />	
				</div>
				<hr>
				<span>파일 목록</span>
