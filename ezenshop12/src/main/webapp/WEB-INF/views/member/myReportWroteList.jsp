				...
				<button type="button" class="btn btn-danger" onclick="location.href='${pageContext.request.contextPath}/member/myWroteList'">자유게시판</button> 
				 ...
				 <button type="button" class="btn btn-danger" onclick="location.href='${pageContext.request.contextPath}/member/myQnaWroteList'">문의게시판</button>  
					...
					<table class="table table-hover">
						<thead>
							<tr><th>번호</th><th>분류</th><th>제목</th><th>등록일</th><th>작성자</th></tr>
								</thead>
					...
					<div class="col-md-offset-3">
						 <ul class="pagination justify-content-center">
						  <c:if test="${pageMaker2.prev}">
						   <li><a href="myReportWroteList?page=${pageMaker2.startPage - 1}" class="page-link">이전</a></li>
						  </c:if> 
						  ...
						  <c:if test="${pageMaker2.next && pageMaker2.endPage > 0}">
						   <li><a href="myReportWroteList?page=${pageMaker2.endPage + 1}" class="page-link">다음</a></li>
						  </c:if> 
						 </ul>
					</div>
