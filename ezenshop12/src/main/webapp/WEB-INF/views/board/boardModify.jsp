	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".cancel_btn").on("click", function(){
				...
				location.href = "/controller/board/boardDetail?fr_no=${modify.fr_no}"
					   + "&page=${scri.page}"
	...
	<body>
		...
		<div id="container" role="main">
			...
			<section id="container">
				<form name="updateForm" role="form" method="post" action="/controller/board/boardModify" enctype="multipart/form-data">
					...
					<div class="col-xs-10 col-sm-10">
            			<div class="col-10">
            					<div class="form-group">
									...
									<input type="text" id="title" name="fr_title" value="${modify.fr_title}" class="chk form-control" title="제목을 입력하세요."/>
								</div>
								<div class="form-group">	
									<label for="content">내용</label>
									<textarea id="content" name="fr_content" class="chk form-control" title="내용을 입력하세요."><c:out value="${modify.fr_content}" /></textarea>
								</div>
								<div class="form-group">
									<label for="writer">작성자</label>
									<input type="text" id="writer" name="member_id" value="${modify.member_id}" class="form-control" readonly="readonly"/>
								</div>
								<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<button type="button" class="cancel_btn btn btn btn-danger">취소</button>
