...
<script type="text/javascript">
	function moveWrite(){
		location.href = "/controller/admin/notice/noticeWrite";
		}
	</script>
</head>
<body>
					...
					<table class="table table-hover">
						...
						<c:forEach items="${list}" var = "list">
							<tr>
								...
								<td>
									<a href="./noticeDetail?notice_no=${list.notice_no}&page=${scri.page}&perPageNum=${scri.perPageNum}&searchType=${scri.searchType}&keyword=${scri.keyword}"><c:out value="${list.notice_title}" /></a>
								</td>
