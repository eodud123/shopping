...
<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".cancel_btn").on("click", function(){
				...
				location.href = "/notice/noticeDetail?fr_no=${modify.notice_no}"
					   + "&page=${scri.page}"
...
<div id="container" role="main">
	...
	<form name="updateForm" role="form" method="post" action="./noticeModify" enctype="multipart/form-data">
							...
							<tr>
								<td id="fileIndex">
									...
									<div>
										...
										<a href="#" id="fileName" onclick="return false;">${file.ORGFILE_NAME}</a>(${file.FILE_SIZE}MB)
					...
					<div class="col-sm-10">
						<button type="button" class="update_btn btn btn-danger btn-block">저장</button>
						<button type="button" class="cancel_btn btn btn btn-dark btn-block">취소</button>
