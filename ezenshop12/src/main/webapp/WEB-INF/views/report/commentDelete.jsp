...
<div class="container">
 ...
 <section id="container">
  ...
  <form role="form" method="post" autocomplete="off">
   ...
   <input type="hidden" id="report_no" name="report_no" value="${readComment.report_no}" readonly="readonly" />
   ...
   <p>
    ...
    $("#cancel_btn").click(function(){   
    	self.location = "/controller/report/reportBoardDetailView?report_no=${readComment.report_no}"
    		   + "&page=${scri.page}"
