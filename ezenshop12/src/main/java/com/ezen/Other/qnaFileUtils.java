...
public class qnaFileUtils {
	...
	public List<Map<String, Object>> parseInsertFileInfo(qnaVO vo, 
	...
	public List<Map<String, Object>> parseUpdateFileInfo(qnaVO vo, String[] files, String[] fileNames, MultipartHttpServletRequest mpRequest) throws Exception{ 
		Iterator<String> iterator = mpRequest.getFileNames();
		MultipartFile multipartFile = null; 
		String originalFileName = null; 
		String originalFileExtension = null; 
